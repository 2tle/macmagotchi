...
final class AppSettings: ObservableObject {
    ...
    init() {
        ...
        feedMinutes = defaults.object(forKey: "feedMinutes") as? Int ?? 60
        sleepMinutes = defaults.object(forKey: "sleepMinutes") as? Int ?? 180
    ...
    func minutesBinding(_ task: PetTask) -> Binding<Int> {
        Binding(get: { self.minutes(task) }) { value in
            switch task {
            case .pet: self.petMinutes = value
            case .play: self.playMinutes = value
            case .feed: self.feedMinutes = value
            case .sleep: self.sleepMinutes = value
            }
        }
    }
    ...
    private let strings: [AppLanguage: [String: String]] = [
        .english: [
            "idle": "Watching the world go by", "newDay": "A new day begins!",
            "feed": "Yum! %{food} is the best.", "play": "Hop, hop! This is fun!",
            "sleep": "Taking a cozy nap", "pet": "Purr… that feels nice!",
            "level": "Lv. %{level} · %{stage}", "hunger": "Hunger", "mood": "Mood",
            "energy": "Energy", "affection": "Bond", "feedButton": "Feed", "playButton": "Play",
            "sleepButton": "Sleep", "petButton": "Pet", "settings": "Settings", "newPet": "New pet",
            "quit": "Quit Macmagotchi", "welcome": "Welcome!", "chooseFriend": "Choose your new friend",
            "namePlaceholder": "Name (e.g. Mochi)", "adopt": "Adopt %{kind}",
            "records": "%{name}'s record", "bondProgress": "Bond %{value} / 125",
            "growthHint": "Grow at bond levels 45 and 100.",
            "decayHint": "Stats decrease a little every 30 minutes.", "language": "Language",
            "resetPet": "Reset pet", "resetTitle": "Reset this pet?",
        ...
        .korean: [
            ...
            "feed": "냠냠! %{food}가 최고예요", "play": "폴짝폴짝, 신나요!",
            "sleep": "포근하게 낮잠을 자요", "pet": "골골… 기분이 좋아요",
            "level": "Lv. %{level} · %{stage}", "hunger": "배고픔", "mood": "기분",
            "energy": "체력", "affection": "친밀도", "feedButton": "밥 주기", "playButton": "놀아주기",
            "sleepButton": "재우기", "petButton": "쓰담", "settings": "설정", "newPet": "새 펫 설정",
            "quit": "맥마고치 종료", "welcome": "반가워요!", "chooseFriend": "함께할 친구를 골라주세요",
            "namePlaceholder": "이름 (예: 모찌)", "adopt": "%{kind} 가족 맞이하기",
            "records": "%{name}의 기록", "bondProgress": "친밀도 %{value} / 125",
            "growthHint": "친밀도가 45, 100이 되면 성장해요.",
            "decayHint": "매 30분마다 상태가 조금씩 줄어요.", "language": "언어",
            "resetPet": "펫 초기화", "resetTitle": "펫을 초기화할까요?",
