...
extension PetDefinition {
    static let cat = PetDefinition(
        ...
        bodyPixels: [
            PetPixel(3, 2, 2, 1, color: .fur), PetPixel(11, 2, 2, 1, color: .fur),
            ...
            PetPixel(4, 9, 8, 1, color: .fur),
            PetPixel(3, 2, 2, 2, color: .dark), PetPixel(11, 2, 2, 2, color: .dark),
            PetPixel(4, 3, color: .cream), PetPixel(11, 3, color: .cream),
